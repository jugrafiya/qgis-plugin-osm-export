...
SOURCES = \
	__init__.py \
	osm_export.py osm_export_dialog.py

PLUGINNAME = osm_export

PY_FILES = \
	__init__.py \
	osm_export.py osm_export_dialog.py

UI_FILES = osm_export_dialog_base.ui
...
QGISDIR=C:\Users\tayya\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
